            ...
            <form enctype="multipart/form-data" action="../actions/edit_member.php" method="post">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="<?= $data['user_gender']?>" class="form-control" id="user_gender" name="user_gender" required>
                    </div>
                    <div class="form-group">
                        <label for="user_tel">เบอร์โทรศัพท์:</label>
                        <input type="text" value="<?= $data['user_tel']?>" class="form-control" id="user_tel" name="user_tel" required>
                    </div>
                    <div class="form-group">
                        <label for="user_address">ที่อยู่:</label>
                        <input type="text" value="<?= $data['user_address']?>" class="form-control" id="user_address" name="user_address" required>
                    </div>
                    <div class="form-group">
                        <label for="user_age">อายุ:</label>
                        <input type="text" value="<?= $data['user_age']?>" class="form-control" id="user_age" name="user_age" required>
                    </div>
